...
var usesDisplayLibrary = function(src) {
  return /\b(dText|dTrace|dLine|dArea|dStep|dMarkers|dBar|dScatter|dLineW|dHistogram|dCandles|dChart|dChartY|dChartY2|dChartLog|dStack|dRow|dCol|dTable|dSheet|dGrid|dSection|dBox)\b/.test(src);
};
