...
export const DEFAULT_NOTEBOOK_DECISION_CELL_LINES = [
  ...
  "-- publish the rolling price history on the CellBus \"prices\" channel so the",
  "-- simulator cell can back-test it. Loops forever via the built-in sleep",
  "-- effect (loopEvery) — press Stop on the cell/nav to end it.",
  ...
  "    let _feed = busQueue(\"prices\", { sym = trimmed, csv = csv }) in",
