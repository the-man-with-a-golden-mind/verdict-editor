      ...
      [ main
          ...
          [ div
              ...
              , div
                  ...
                  , Link.link
                      Index
                      { className: "ml-3 text-sm font-medium text-slate-400 transition-colors hover:text-white" }
                      [ text "Home" ]
                  ]
              ]
          , div
              { className: "relative flex-1 min-h-0" }
              [ element "verdict-editor-debug" {} [] ]
          ]
      ]
  }
